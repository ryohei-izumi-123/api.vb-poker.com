...
const RatesController = require('../controllers/rate')
...
module.exports = {
  list: {
    method: 'get',
    path: `/${config.endpoint.private}/rates`,
    middlewares: [
  ...
  getOne: {
    method: 'get',
    path: `/${config.endpoint.private}/rates/:id(\\d+)`,
    middlewares: [
      Context.validateAnyScope.bind(Context),
      Authenticate.authenticate.bind(Authenticate),
      Acl.canAccess.bind(Acl),
  ...
  status: {
    method: 'patch',
    path: `/${config.endpoint.private}/rates/:id(\\d+)/status`,
    middlewares: [
      Context.validateAnyScope.bind(Context),
      Authenticate.authenticate.bind(Authenticate),
      Acl.canAccess.bind(Acl),
