...
const WebpagesController = require('../controllers/webpage')
const Controller = new WebpagesController()
...
module.exports = {
  list: {
    method: 'get',
    path: `/${config.endpoint.private}/webpages`,
    middlewares: [
  ...
  getOne: {
    method: 'get',
    path: `/${config.endpoint.private}/webpages/:id(\\d+)`,
    middlewares: [
      Context.validateAnyScope.bind(Context),
      Authenticate.authenticate.bind(Authenticate),
      Acl.canAccess.bind(Acl),
  ...
  status: {
    method: 'patch',
    path: `/${config.endpoint.private}/webpages/:id(\\d+)/status`,
    middlewares: [
      Context.validateAnyScope.bind(Context),
      Authenticate.authenticate.bind(Authenticate),
      Acl.canAccess.bind(Acl),
